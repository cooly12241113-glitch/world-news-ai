...
const OUTCOME_BY_REASON: Readonly<Record<string, SourceAcquisitionFailureOutcome>> =
  Object.freeze({
    ...
    HTTP_AUTHENTICATION_REQUIRED: "authentication-required",
    HTTP_ACCESS_DENIED: "access-denied",
    HTTP_RESOURCE_UNAVAILABLE: "unavailable",
    HTTP_STATUS_NOT_ACCEPTED: "failed",
